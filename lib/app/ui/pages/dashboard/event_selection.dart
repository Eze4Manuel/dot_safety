                ...
                Row(
                  ...
                  children: [
                    EventBlock(context, Strings.crimeOffence,
                        Offence(offenceTitle: "Crime Offence"), false),
                    EventBlock(context, Strings.stopAndSearch,
                        Offence(offenceTitle: "Stop And Search"), false),
                  ],
                ),
                SizedBox(
                  height: DeviceUtils.getScaledHeight(context, scale: 0.04),
                ...
                Row(
                  ...
                  children: [
                    EventBlock(context, Strings.trafficOffence,
                        Offence(offenceTitle: "Traffic Offence"), false),
                    EventBlock(context, Strings.drugTrafficking,
                        Offence(offenceTitle: "Drug Trafficking"), false),
                  ],
                ),
                SizedBox(
                  height: DeviceUtils.getScaledHeight(context, scale: 0.04),
                ...
                Row(
                  ...
                  children: [
                    EventBlock(context, Strings.illegalBunkering,
                        Offence(offenceTitle: "Illegal Bunkering"), false),
                    EventBlock(context, Strings.others,
                        Offence(offenceTitle: "Others"), false),
                  ],
                ),
                SizedBox(
                  height: DeviceUtils.getScaledHeight(context, scale: 0.04),
